...
export const overviewData = [
  ...
  export const priceData = [
    { property: "Закупочная цена", value: "600 руб." },
    { property: "Розничная цена", value: "1200 руб." },
    { property: "Оптовая цена", value: "1000 руб." },
    { property: "Отпускная цена", value: "600 руб." },
  ];
  ...
  export const normativesData = [
    {
      property: "Мелирование на фольгу - от 0 до 10 мл",
      value: "0 мл",
    },
    {
      property: "Коррекция длины волос - 0 мл",
      value: "0 мл",
    },
  ];
  ...
  export const productData = [
    { property: "Может быть товаром", value: "Нет" },
  ];
  
  // Floating Price Table Data
  export const floatingPriceData = [
    { from: 10, to: 20, cost: 100, unit: "руб." },
    { from: 10, to: 20, cost: 100, unit: "руб." },
  ];
  
  // Photo Section (Placeholder)
  export const photoData = [
    { property: "Фотография", value: "", link: "#", linkLabel: "+ Добавить файлы" }
  ];
