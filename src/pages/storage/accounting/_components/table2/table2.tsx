        ...
        <TableContainer component={Paper}
            ...
            <Box sx={{ borderRadius: "8px", border: "0.1rem solid var(--neutral-300)" }}>
                ...
                <TableHead>
                    ...
                    <TableCell>
                        <div>
                        <CustomTextField label={"Эстетика-лицо"} size="small" style= {{width: "29rem"}}/>
                        </div>
                    </TableCell>
                ...
                <TableBody>
                    ...
                    <TableCell>
                        <div>
                        <CustomTextField label={"Выберите материал или считайте штрих-код"} size="small" style={{width: "50rem"}}/>
                        </div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                        <div className={classes.table__cell}>
                        <div className ={classes.table__cell__quantity}>
                            <QuantitySelector unit="закуп." />
                            <QuantitySelector unit="розн." />
                            <QuantitySelector unit="% от закуп." />
                        </div>
                        <div className={classes.table__cell__counter}>
                            <p>Итого: 0 руб.</p>
                        </div>
