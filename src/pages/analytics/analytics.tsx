...
const AnalyticsPage = () => {
  ...
  const imageDescriptions = {
    "master_rating.png": "Распределение рейтинга мастеров в зависимости от должности сотрудников.",
    "corr_matrix.png": "Матрица корреляции между различными характеристиками сотрудников.",
    ...
    "avg_bill_visits_count.png": "Связь между средним счётом и количеством визитов по должностям сотрудников.",
    "active_idle_hours.png": "Сравнение активного времени работы и времени простоя сотрудников.",
    "months_total_before_discounts.png": "Зависимость общего дохода до скидок от количества месяцев работы сотрудников.",
    "client_types.png": "Распределение типов клиентов: новые, постоянные и корпоративные.",
    "avg_bill_kde.png": "Плотность распределения среднего счёта.",
    "pairplot.png": "Парные графики показывают взаимосвязи между различными характеристиками сотрудников.",
    "employee_analysis_revenue.png": "Совокупный анализ дохода от услуг и продаж, а также количество визитов, новых клиентов и рейтинг сотрудников.",
    "salary_distribution.png": "Распределение зарплат сотрудников, отсортированное по убыванию.",
    "visits_by_day.png": "Распределение посещений по дням недели для разных годов.",
    "visits_by_month.png": "Распределение посещений по месяцам для разных годов.",
    "visits_by_hour.png": "Распределение посещений по времени суток для разных годов.",
    "discount_detailed_analysis.png": "Анализ скидок: количество визитов, общий доход и средний доход на визит в зависимости от категории скидки.",
    "total_before_after_discounts.png": "Сравнение общей суммы до и после скидок.",
    "revenue_structure.png": "Структура выручки: разбиение на услуги, продукты и сертификаты.",
    "average_transaction.png": "Распределение суммы одной транзакции с отображением средней суммы.",
          ...
          children={
            <div className={classes["main__content__grid"]}>
              <Box className={classes["image-container"]}>
                <img src={images[0]} onClick={() => openImageViewer(0)} />
                <Typography variant="h6" align="center" className={classes["image-text"]}>
