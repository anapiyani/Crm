...
const IndirectCostsPage: FC = () => {
  ...
  const reportPeriod = () => {
    return (
      indirectCostsData &&
      Number(indirectCostsData.administrative_expenses) +
        Number(indirectCostsData.expenses_on_checks_cash_register) +
        Number(indirectCostsData.operational_expenses) +
        Number(indirectCostsData.production_expenses)
    );
  };
        ...
        <div className={classes.main__content__result}>
          <div className={classes.main__content__result__item}>
            ...
            <div className={classes.main__content__result__wrap}>
              ...
              {openTables.table1 && indirectCostsData?.production_expenses && (
            ...
            <div className={classes.main__content__result__wrap}>
              ...
              {openTables.table2 && indirectCostsData?.operational_expenses && (
                <Table className={classes.table}>
                  <TableHead>
                    <TableRow>
                      <TableCell>Дата</TableCell>
              ...
              {openTables.table3 &&
                indirectCostsData?.administrative_expenses && (
                  <Table className={classes.table}>
                    ...
                    <TableBody>
                      {indirectCostsData.administrative_details.map(
                        (item, index) =>
                          item.operations.map((operation, index) => (
                            <TableRow key={index}>
                              <TableCell>
            ...
            <div className={classes.main__content__result__wrap}>
              ...
              >
                ...
                >
                  <h1>
                    -{indirectCostsData?.expenses_on_checks_cash_register} руб
                  </h1>
                  <span style={{ paddingTop: '8px' }}>
                    {openTables.table4 ? (
                      <ExpandLess style={{ fontSize: '24px' }} />
              ...
              {openTables.table4 &&
                indirectCostsData?.expenses_on_checks_cash_register && (
                  <Table className={classes.table}>
                    ...
                    <TableBody>
                      {indirectCostsData.checks_cash_register_details.map(
                        (item, index) =>
                          item.operations.map((operation, index) => (
                            <TableRow key={index}>
                              <TableCell>
